  ...
  if (gpxWaypoints && gpxWaypoints.length) {
    gpxWaypoints.forEach(function (wayPoint) {
      var point = new GpxWaypoint(
        ...
        null,
        null,
        getFloat(wayPoint.speed),
        getFloat(wayPoint.sat)
      );
    ...
    gpxTracks.forEach(function (currentTrack) {
      ...
      if (currentTrack.trkseg && currentTrack.trkseg.length) {
        currentTrack.trkseg.forEach(function (currentSegment) {
          ...
          if (currentSegment.trkpt && currentSegment.trkpt.length) {
            currentSegment.trkpt.forEach(function (trackPoint) {
              ...
              var speed = getFloat(trackPoint.speed);
              var sat = getFloat(trackPoint.sat);
              var tp = new GpxWaypoint(
                trackPoint.$.lat,
                trackPoint.$.lon,
                elevation,
                trackPoint.time,
